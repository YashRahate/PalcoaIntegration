  ...
  const slides = [
    {
      ...
      title: "X SALON",
      subtitle: "Welcome to",
      description: "Experience Beauty Like Never Before!",
    ...
    },
    {
      ...
      subtitle: "Welcome to",
      description:
        "Our online store is stocked with high-quality beauty and haircare products from leading brands.",
...
const Testimonials = () => {
  const testimonials = [
    {
      name: "Arya",
      text: "The staff is friendly, warm, and cooperative. They greet me with happy faces all the time. No matter which eyebrow threader I choose, I get the same shape every time with the utmost perfection. Love this place and its atmosphere.",
      image: img,
    },
    {
      name: "Sharvari",
      text: "Amy did my lash extensions with utter accuracy and perfection. She even gives a guarantee that if you don’t like your lashes, she’ll refund your money. Her skill level matches her confidence level!",
      image: img,
    },
    {
      name: "Shilpa",
